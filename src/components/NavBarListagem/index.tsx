// Navbar fixed para as páginas de listagens que são mais compridas
import { useState } from "react";
import { useRouter } from "@tanstack/react-router";


interface NavBarListagemProps { // Navar aberta ou fechada
...
function NavBarListagem({ onToggle }: NavBarListagemProps) {
  ...
  return (
    ...
    <div
      className={`${isNavOpen ? "w-64" : "w-16"} fixed top-0 left-0 h-full bg-azuljava
     text-white transition-all duration-500 rounded-r-lg`}
